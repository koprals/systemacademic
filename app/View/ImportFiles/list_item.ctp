	...
	<table cellpadding="0" cellspacing="0" width="100%" class="sTable mTable">
		<thead>
			<tr>
				...
				<td style="width:10%;">
					<?php echo $this->Paginator->sort("$ModelName.mime_type",'Mime Type');?>
				</td>
				<?php
				if(
					$access[$aco_id]["_update"] == 1 or
		...
		<tbody>
            ...
            <?php
              if($data['File']['mime_type'] == "image/gif") {
                ?>
                <a rel="lightbox" title="<?php echo $data[$ModelName]['title'] ?>" href="<?php echo $data["File"]["host"].$data["File"]["url"]?>?time=<?php echo time()?>" style="border:0px;">
                <img src="<?php echo $data["File"]["host"].$data["File"]["url"]?>?time=<?php echo time()?>" width="100"/>
                </a>
                <?php
              } else {
                ?>
                <a rel="lightbox" title="<?php echo $data[$ModelName]['title'] ?>" href="<?php echo $data["File"]["host"].$data["File"]["url"]?>?time=<?php echo time()?>" style="border:0px;">
                <img src="<?php echo $data["File"]["host"].$data["File"]["url_thumb"]?>?time=<?php echo time()?>" width="100"/>
                </a>
                <?php
              }
            ?>
					...
					<td style="text-align:center;"><?php echo $data[$ModelName]['mime_type'] ?></td>
					<?php
					if(
						$access[$aco_id]["_update"] == 1 or
						$access[$aco_id]["_delete"] == 1
					...
					<td style="text-align:center;">
						<?php if($access[$aco_id]["_update"] == 1):?>
							...
							<?php if($data[$ModelName]['status']=="1"):?>
								<a href="javascript:void(0);" onclick="ChangeStatus('Do you realy want hide this news ?','<?php echo $data[$ModelName]['id']?>','0')" class="tipS smallButton greenB" title="Hide">
						...
						<?php if($access[$aco_id]["_delete"] == 1):?>
							<a href="javascript:void(0);" onclick="Delete('Do you realy want to delete this agent?','<?php echo $data[$ModelName]['id']?>')" class="tipS smallButton redB" title="Delete">
