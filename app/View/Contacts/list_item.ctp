...
<div class="widget">
	<div class="title">
		...
		<h6>
			Sales Team - Page <?php echo $this->Paginator->counter(); ?>
		</h6>
	</div>
	<div class="title">
	...
	<table cellpadding="0" cellspacing="0" width="100%" class="sTable mTable">
		<thead>
			<tr>
				...
				<td style="width:15%;">
					<?php echo $this->Paginator->sort("$ModelName.address",'Address');?>
				</td>
				<td style="width:20%;">
					<?php echo $this->Paginator->sort("$ModelName.email",'Email');?>
				</td>
				<td style="width:15%;">
					<?php echo $this->Paginator->sort("$ModelName.phone_number",'Phone Number');?>
				</td>
				<td style="width:10%;">
		...
		<tbody>
			...
			<?php foreach($data as $data): ?>
				...
				<tr <?php echo $class?>>
					...
					<td><?php echo $this->Text->truncate($data[$ModelName]['office_address'],20,"<br/>") ?></td>
					<td><?php echo $data[$ModelName]['email'] ?></td>
					<td><?php echo $data[$ModelName]['phone_number'] ?></td>
