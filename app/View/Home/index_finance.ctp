                ...
                if(isset($appointments) && !empty($appointments)) {
                    foreach($appointments as $ctr => $appointment) {
                      ...
                      <div class="wUserInfo">
                          ...
                          <ul class="rightList">
                              <li>
                                <a href="<?php echo $this->Html->url(array('controller' => 'Invoices', 'action' => 'Edit', $appointment['Appointment']['id'])) ?>" title="" class="button greenB" style="margin: 5px;"><img src="<?php echo $this->webroot ?>img/icons/light/check.png" alt="" class="icon">
