...
<div class="wrapper">
    ...
    <div class="fluid">
                ...
                if(isset($appointments) && !empty($appointments)) {
                    foreach($appointments as $ctr => $appointment) {
                      ...
                      <div class="wUserInfo">
                          ...
                          <ul class="rightList">
                              <li>
                                <a href="<?php echo $this->Html->url(array('controller' => 'Home', 'action' => 'Observe', $appointment['Appointment']['id'])) ?>" title="" class="button greenB" style="margin: 5px;"><img src="<?php echo $this->webroot ?>img/icons/light/check.png" alt="" class="icon">
                                  <span>Observe Patient</span>
                                </a>
                              </li>
                          </ul>
                      </div>
      ...
      <!-- 2 columns widgets -->
        <div class="span6">
          <div class="widget">
              <div class="title"><img src="<?php echo $this->webroot ?>img/icons/dark/users.png" alt="" class="titleIcon" /><h6>Patient List - In Doctor Room</h6></div>
