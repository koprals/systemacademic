          ...
          <div class="widget">
              ...
              <div class="tabs tabs-sortable">
                  <ul>
                      ...
                      <li><a href="#tabs-9">Product List</a></li>
                                      ...
                                      <div class="formRight">
                                        <?php
                                          ...
                                          if($stringKeyArray != "") {
                                            ...
                                            echo $this->Form->input('AppointmentItem.'.$keyArray.'.Item.item_type_id', array(
                                              'type' => 'hidden',
                                            ));

                                            echo $this->Form->input('AppointmentItem.'.$keyArray.'.Item.price', array(
                                              'type' => 'hidden',
                                            ));
