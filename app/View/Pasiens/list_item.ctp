...
<div class="widget">
	<div class="title">
		...
		<h6>
			Pasiens - Page <?php echo $this->Paginator->counter(); ?>
		</h6>
	</div>
	<div class="title">
				...
				<tr <?php echo $class?>>
					...
					<td style="text-align:center;">
						...
						<?php if($access[$aco_id]["_update"] == 1):?>
							<a href="<?php echo $settings['cms_url'].$ControllerName?>/Edit/<?php echo $data[$ModelName]["id"]?>" class="tipS smallButton blueB" title="Edit">
