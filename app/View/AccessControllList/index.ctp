	...
	<div class="span6">
		<div class="bc">
	        <ul id="breadcrumbs" class="breadcrumbs">
				 ...
				 <li class="current">
	                  <a href="javascript:void(0)" style="cursor:default"><?php echo $detailAro["MyAro"]["alias_name"]?></a>
	             </li>
	        </ul>
	    </div>
					...
					<tr>
						<td colspan="6">
							<div class="formSubmit">
								...
								<input type="button" value="Cancel" class="blackB" onclick="location.href = '<?php echo $settings["cms_url"]?>Aros/Index/<?php echo $page?>/<?php echo $viewpage?>'" style="width:100px;"/>
							</div>
						</td>
					</tr>
				</tfoot>
