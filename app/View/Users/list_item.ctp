		...
		<tbody>
			...
			<?php foreach($data as $data): ?>
				...
				<tr <?php echo $class?>>
					...
					<td>
						<a rel="lightbox" title="<?php echo $data[$ModelName]['username'] ?>" href="<?php echo $data["Image"]["host"].$data["Image"]["url"]?>?time=<?php echo time()?>" style="border:0px;">
						<img class="lazy" src="" data-src="<?php echo $data["Image"]["host"].$data["Image"]["url"]?>?time=<?php echo time()?>" width="60"/>
						</a>
					</td>
					<td>
						<?php
						echo $this->Html->link($data[$ModelName]['name'], array('action' => 'view', $data[$ModelName]['id']));
