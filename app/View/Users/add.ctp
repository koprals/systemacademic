  ...
  <div class="fluid">
      <div class="span12">
          <div class="widget">
						...
						<div class="title"><img src="<?php echo $this->webroot ?>img/icons/dark/settings.png" alt="" class="titleIcon" /><h6>Add New User</h6>
						</div>
              <div class="tabs tabs-sortable">
                  ...
                  <div id="tabs-7">
                      <fieldset>
		                        ...
		                        <div class="formRight">
															<input name="data[User][images]" type="file" accept="image/*" />
		                        </div>
		                    </div>
												<?php
