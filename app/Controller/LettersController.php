  ...
  var $components = array("RequestHandler");
	...
	function beforeFilter()
	{
		...
		$find					=	$this->MyAco->find("first",array(
										"conditions"	=>	array(
											"LOWER(MyAco.alias)"	=>	strtolower("Letters")
										)
									));
    ...
    //DEFINE JENIS SURAT
    $this->loadModel('LetterType');
    $find_surats  = $this->LetterType->find('list');
    $this->set('find_surats', $find_surats);
	}
